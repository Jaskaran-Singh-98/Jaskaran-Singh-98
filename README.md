...
- **Observability** — Azure Monitor, Application Insights, Log Analytics, custom dashboards  
- **Cloud** — Azure (AKS, App Service, Key Vault, Logic Apps, Service Bus)  
- **Security** — GPG-signed commits, Azure Policy, compliance automation  
...
## 📫 Get in Touch
- 📧 [Email](mailto:jassafzr05@gmail.com)  
- 🔗 [LinkedIn](https://www.linkedin.com/in/jaskaran-singh-technophile/)  
- 💻 [GitHub](https://github.com/Jaskaran-Singh-98)
